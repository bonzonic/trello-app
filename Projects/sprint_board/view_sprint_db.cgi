			...
			<form action = "view_sprint_db_2.cgi">
				<div id="main">
					...
					<div style="margin-top:30px ;">
						...
						<input type="hidden" name="row" value = "$sprint_id">
						<input type="hidden" name="row2" value = "1">
						<input type = "submit" class="btn btn-primary" role="button" value = "Get Started" style="float:right;">
